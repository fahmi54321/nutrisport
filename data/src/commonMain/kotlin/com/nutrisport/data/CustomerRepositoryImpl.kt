...
class CustomerRepositoryImpl : CustomerRepository {
        ...
        try {
            if (user != null) {
                ...
                val customer = Customer(
                    ...
                    lastName = user.displayName?.split(" ")?.firstOrNull() ?: "Unknown",
            ...
            onError("Error whole creating a Customer: ${e.message}")
        }
    }
    ...
    override fun readCustomer(): Flow<RequestState<Customer>> = channelFlow {
        try {
                    ...
                    .collectLatest { document ->
                        if (document.exists) {
                            ...
                            val customer = Customer(
                                ...
                                cartItem = document.get(field = "cartItem"),
    ...
    override suspend fun updateCustomer(
        ...
        try {
            ...
            onError("Error while updating a Customer information")
        }
    }
